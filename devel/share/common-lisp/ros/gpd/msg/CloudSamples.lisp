...
(cl:defmethod cl:initialize-instance :after ((m <CloudSamples>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CloudSamples)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gpd-msg:<CloudSamples> is deprecated: use gpd-msg:CloudSamples instead.")))
